...
; Conecto LED en el pin 11 de ARDUINO UNO (Pin B3).
; Configuro puerto B.
...
prendo:		sbi		PORTB,3 	; Se enciende el LED.
								; Poniendo un 1 lógio (Que se traduce a 5 Volts) en el Pin 3 del puerto B.
